...
2) Пытается выровнять документ на фото  
3) Распознаёт текст на выровненном изображении с помощью **EasyOCR (PyTorch)**  
4) Рисует bbox текста на изображении  
5) Пытается извлечь из текста основные поля (например: ФИО, дата рождения, номер документа)  
6) Возвращает:
